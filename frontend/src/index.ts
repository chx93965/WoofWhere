...
// // Track username → socketId for private messaging
// let userSockets: Record<string, string> = {};
...
//     socket.emit("private_history", data || []);
//   });
...
//     // Send to sender (local echo)
//     socket.emit("receive_private_message", message);

//     // Send to recipient if online
//     const recipientSocket = userSockets[recipient];
//     if (recipientSocket) {
//       io.to(recipientSocket).emit("receive_private_message", message);
//     }
//   });
